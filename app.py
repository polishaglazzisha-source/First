...
# --------------------
# Конфигурация Google Sheets (устойчивое чтение + краткая диагностика)
# --------------------
...
q1_options = [
    ...
    'Единство и развитие всех людей',
    'Здоровье',
    'Карьера',
    'Личностный рост',
    'Материальный достаток',
    'Общественное признание',
    'Отсутствие нужды в чем-то, что важно для нормальной жизни',
    'Подобрать увлечение, согласующееся с моей натурой',
    ...
    'Сохранение сил в кризисных условиях',
    'Стабильность',
    'Строительство более гуманного и терпимого общества',
    'Уважение среди знакомых',
...
b2_text = {
    ...
    3: 'Обдумываете ли вы свои дела не спеша и предпочитаете ли подождать, прежде чем действовать?',
    4: 'Всегда ли вы сдерживаете свои обещания, даже если это вам невыгодно?',
    5: 'Быстро ли вы обычно действуете и говорите, не тратите ли много времени на обдумывание?',
    6: 'Верно ли, что на спор вы способны решиться на всё?',
    7: 'Бывает ли когда-нибудь, что, разозлившись, вы выходите из себя?',
    8: 'Часто ли бывает, что вы действуете необдуманно, под влиянием момента?',
    9: 'Любите ли вы часто бывать в компании знакомых и друзей?',
    10: 'Бывают ли иногда у вас такие мысли, которыми вам не хотелось бы делиться с другими людьми?',
    11: 'Стараетесь ли вы ограничить круг своих знакомых небольшим числом самых близких друзей?',
    12: 'Когда на вас кричат, отвечаете ли вы тем же?',
    13: 'Считаете ли вы все свои привычки хорошими?',
    14: 'Способны ли вы иногда дать волю своим чувствам и беззаботно развлечься с веселой компанией?',
    15: 'Слывете ли вы за человеком активным и весёлым?',
    16: 'Чувствуете ли вы себя неспокойно, находясь в большой компании?',
    17: 'Бывает ли, что вы передаёте слухи?',
    18: 'Нравится ли вам работа, требующая сосредоточения?',
    19: 'Всегда ли вы говорите только правду?',
    20: 'Бывает ли вам неприятно находиться в компании, где все подшучивают друг над другом?',
    21: 'Верно ли, что вы неторопливы в движениях и несколько медлительны?',
    22: 'Опаздывали ли вы когда-нибудь на работу или на встречу с кем-либо?'
}

q3_options = [
    'В жизни играю так много ролей на работе, дома и в обществе, что боюсь потери себя',
    'В конфликте убеждаю себя и других, что проблема не стоит «выеденного яйца»',
    'В неопределённости большое напряжение, усталость, нет ощущения отдыха',
    'В неудаче говорю себе: «Нужно попробовать ещё раз»',
    'В ссоре легко выражаю чувства, обозначаю потребности, выслушиваю других',
    'Возникающие трудности необходимо преодолевать',
    'Думаю, что всё равно преодолею препятствия и добьюсь своего',
    'Если обидели — сильно переживаю и беспокоюсь',
    'Если не удаётся — упорствую и прилагаю все усилия',
    'Если вспылил — веду себя отстранённо несколько дней',
    'Откладываю решение проблемы в надежде, что решится сама',
    'Конфликт угнетает — ухожу в другие дела/жду, что время расставит точки',
    'Неудачи побуждают к ещё большим усилиям',
    'Неудачи побуждают переключиться, чтобы забыть',
    'По возможности избегаю решительных действий при ссорах',
    'Поражения побуждают во мне новые силы',
    'После ссоры чувствую вину и стараюсь восстановить отношения',
    'Ситуации стресса принимаю близко к сердцу и сильно переживаю',
    'Столкнувшись с проблемой, ищу поддержку у окружающих',
    'Стресс выматывает — берегу энергию, надеюсь, что всё рассосётся',
    'Тревога при неопределённости, трудно контролировать эмоции'
]

q4_options = [
    'Говорил с кем-либо, кто мог конкретно помочь',
    'Думал о том, как бы действовал человек, которым я восхищаюсь',
    'Знал, что надо делать, и удваивал усилия',
    'Молился',
    'Набирался опыта в данной ситуации',
    'Находил новую веру во что-то',
    'Отказывался воспринимать это слишком серьёзно',
    'Пользовался прошлым опытом – мне приходилось уже попадать в такие ситуации',
    'Пытался улучшить самочувствие едой, выпивкой, курением или лекарствами',
    ...
    'Стоял на своём и боролся за то, чего хотел',
    'Что-то менял в своей жизни так, что всё улаживалось',
    'Что-то менял в себе',
    'Свой вариант'
]

q5_items = [
    'Участвую в молодежных образовательных форумах',
    'Участвую в добровольческой (волонтерской) деятельности',
    'Являюсь членом социально ориентированных НКО, молодежных общественных объединений',
    'Участвую в выборах',
    'Участвую в деятельности молодежного парламента / правительства',
    'Участвую в деятельности политической партии',
    'Участвую в вожатской деятельности (педагогические отряды)',
    'Реализую собственный проект',
    'Участвую в поисковой деятельности (военно-патриотическая деятельность)',
    'Участвую в научных и/или творческих коллективах',
    'Занимаюсь студенческим/ученическим самоуправлением',
    'Свой вариант'
]
FREQ3 = ['Регулярно', 'Иногда', 'Никогда']
MAP_Q5 = {'Регулярно': 2, 'Иногда': 1, 'Никогда': 0}

q6_items = [
    'Высказывание позиции по общественно-значимым и политическим проблемам в блогах, форумах, социальных сетях, в комментариях на новостных сайтах',
    'Посещение сайтов политических партий, общественных (некоммерческих) организаций',
    'Посещение сайтов/страниц в социальных сетях отдельных общественных деятелей, политических активистов',
    'Участие в интернет-опросах и голосованиях',
    'Подписание общественных петиций, обращений',
    'Размещение информации о местных (локальных) значимых общественных, социальных и политических проблемах на новостных сайтах, на страницах в социальных сетях',
    'Размещение информации об общенациональных значимых общественных, социальных и политических проблемах на новостных сайтах, на страницах в социальных сетях',
    'Участие в экспертизе / публичной оценке законопроектов',
    'Вступление в сообщества / подписка на официальные страницы политических партий',
    'Вступление в сообщества / подписка на официальные страницы общественных (некоммерческих) организаций',
    'Вступление в сообщества / подписка на официальные страницы политических деятелей',
    'Вступление в сообщества / подписка на официальные страницы общественных деятелей',
    'Распространение информации о местных (локальных) значимых общественных, социальных и политических проблемах на новостных сайтах, на страницах в социальных сетях',
    'Распространение информации об общенациональных значимых общественных, социальных и политических проблемах на новостных сайтах, на страницах в социальных сетях',
...
def validate_multiselect(values, min_sel=None, max_sel=None):
    ...
    if min_sel is not None and n < min_sel:
        return False, f'нужно минимум {min_sel}'
    if max_sel is not None and n > max_sel:
        return False, f'можно не более {max_sel}'
    return True, ''
...
st.markdown(
    ...
    'направленности. Мы просим принять участие в нашем исследовании, ответив на вопросы анкеты (это займет 7-10 минут), а также '
    'если вы готовы принять участие в продолжении исследования в форме фокус-групп и получить подарки от Школы коммуникаций, '
    'оставьте, пожалуйста, свой электронный адрес.\n\n'
...
st.markdown('---')
st.subheader('1. Выберите, пожалуйста, что из перечисленного Вы считаете для себя наиболее важным')
st.caption('Укажите от 3 до 5 вариантов')
q1_vals = st.multiselect('Отметьте варианты', q1_options)

st.markdown('---')
st.subheader('2. Перед Вами вопросы, направленные на выявление вашего обычного способа поведения в жизни. Постарайтесь представить типичные ситуации и дайте первый «естественный» ответ, который придет вам в голову')
st.caption('Если вы согласны с утверждением, то отвечайте «да», если нет – то отвечайте «нет»')
b2_answers = {}
for i in range(1, 23):
    b2_answers[f'b2_{i}'] = st.radio(f'{i}. {b2_text[i]}', ['Да', 'Нет'], horizontal=True, key=f'b2_{i}')

st.markdown('---')
st.subheader('3. Выберите, пожалуйста, что из перечисленного Вы считаете наиболее подходящей реакцией для себя в ситуации испытываемого стресса или неопределенности')
st.caption('Можно указать от 4 до 7 вариантов')
q3_vals = st.multiselect('Отметьте варианты', q3_options)

st.markdown('---')
st.subheader('4. Завершите предложение, пожалуйста, продолжив его выбором из нижеследующего перечня, что считаете для себя наиболее важным: «Оказавшись в трудной ситуации, я …')
st.caption('Можно указать до 3 вариантов')
q4_vals = st.multiselect('Отметьте варианты', q4_options, max_selections=3)
q4_free = ''
if 'Свой вариант' in q4_vals:
    q4_free = st.text_area('Опишите «Свой вариант»', '')
...
q5_free_text = ''
if q5_own_enabled:
    q5_free_text = st.text_input('Опишите «Свой вариант»', '')

st.markdown('---')
st.subheader('6. Как часто за последний год вы пользовались интернет-возможностями, чтобы повлиять на те или иные общественно-политические вопросы?')
...
q6_free_text = ''
if q6_own_enabled:
    q6_free_text = st.text_input('Опишите «Свой вариант»', '')
...
q8 = q9 = q10 = ''
if q7 == 'ДА':
    q8 = st.text_area('8. Какую мечту Вы бы хотели реализовать до конца 2025 года?', '')
    q9 = st.text_area('9. Какие мечты Вы бы хотели реализовать в ближайшие пять лет?', '')
    q10 = st.text_area('10. Какие мечты Вы бы хотели реализовать в ближайшие десять-двадцать лет?', '')
...
if submitted:
    ...
    if q7 == 'ДА':
        ...
        if not q9 or not _has_cyrillic(q9):
            errors.append('П.9: обязательный ответ (кириллица).')
        if not q10 or not _has_cyrillic(q10):
            errors.append('П.10: обязательный ответ (кириллица).')
